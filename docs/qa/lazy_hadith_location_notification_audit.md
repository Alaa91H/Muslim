...
**Status:** Published as [`v1.25.12`](https://github.com/Alaa91H/Muslim/releases/tag/v1.25.12) after [tag CI](https://github.com/Alaa91H/Muslim/actions/runs/33079798670) completed successfully: quality, Android emulator, and signed release-artifact jobs passed. The phone `app-release.apk` SHA-256 (`b3e6bf5be7780b4afbecbe780ccb89e661a6c1667afb026f398eafd96aeb3cae`) and Wear `wear-release.apk` SHA-256 (`d861c634d3e9279a5d552ba15fdba171d0a2ded97a6388f55e1eec79edd08a2f`) were downloaded from the release and matched GitHub's published asset digests. This workspace still has no configured Android SDK, so its local evidence remains limited to static guards and Detekt.
