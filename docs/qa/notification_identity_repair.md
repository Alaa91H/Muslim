...
| Status bar | Every production notification producer uses `ic_muslim_status_bar_v2029`, whose approved seven-part line-art geometry matches the themed launcher monochrome layer. | Android applies the final light/dark system tint to a small notification icon. |
...
| Status-bar glyph | `ic_muslim_status_bar_v1252`, `ic_muslim_status_bar_v2026`, `ic_muslim_status_bar_v2027`, `ic_muslim_status_bar_v2028` | `ic_muslim_status_bar_v2029` |
