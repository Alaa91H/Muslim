...
| Status bar | Every production notification producer uses `ic_muslim_status_bar_v2029`, whose exact user-approved traced silhouette is shared with the themed launcher monochrome layer. | Android applies the final light/dark system tint to a small notification icon. |
