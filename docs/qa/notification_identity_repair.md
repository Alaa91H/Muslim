...
| Status bar | Every production notification producer uses `ic_muslim_status_bar_v2029`, whose complete four-path geometry matches the themed launcher monochrome layer. | Android applies the final light/dark system tint to a small notification icon. |
