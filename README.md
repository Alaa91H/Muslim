...
| المرحلة 1: الأذان، أوقات الصلاة، القبلة، التقويم الهجري | 🔶 قيد التنفيذ — المحرك الفلكي، القبلة، الهجري، الشاشات، وجدولة الأذان منفّذة ومُختبَرة (التفاصيل في PROJECT_PROMPT.md) |
| المراحل 2–8 | ⬜ لم تبدأ بعد |
