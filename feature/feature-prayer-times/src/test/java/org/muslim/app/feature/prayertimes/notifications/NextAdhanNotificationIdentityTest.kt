...
class NextAdhanNotificationIdentityTest {
    ...
    fun `next adhan notification uses a fresh identity separate from the retired ongoing card`() {
        ...
        assertThat(NextAdhanNotifications.NEXT_ADHAN_NOTIFICATION_ID).isEqualTo(1013)
        assertThat(NextAdhanNotifications.RETIRED_COUNTDOWN_NOTIFICATION_ID).isEqualTo(1011)
    }
}
