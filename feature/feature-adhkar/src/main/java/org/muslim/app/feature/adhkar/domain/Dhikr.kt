...
enum class DhikrCategory(
    ...
    Home("home", R.string.adhkar_category_home),
    Mosque("mosque", R.string.adhkar_category_mosque),
    Wudu("wudu", R.string.adhkar_category_wudu),
    Clothing("clothing", R.string.adhkar_category_clothing),
    Restroom("restroom", R.string.adhkar_category_restroom),
    Illness("illness", R.string.adhkar_category_illness),
