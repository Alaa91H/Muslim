...
NEW_KEYS = {
    os.path.join(PROJECT_ROOT, "app", "src", "main", "res"): [
        ...
        "more_quran_search",
        "more_quran_search_desc",
        "more_quran_frequency",
        "more_quran_frequency_desc",
        "more_pause_on_notifications",
        "more_pause_on_notifications_desc",
        "more_pause_notifications_enabled",
        "more_pause_notifications_disabled",
        "crash_title",
        "crash_fatal_message",
    ...
    os.path.join(PROJECT_ROOT, "feature", "feature-adhkar", "src", "main", "res"): [
        "adhkar_copy",
        "adhkar_share",
        "adhkar_overlay_short_only",
        "adhkar_overlay_short_only_desc",
        "adhkar_overlay_tap_hint",
    ],
    os.path.join(PROJECT_ROOT, "feature", "feature-hadith", "src", "main", "res"): [
        "hadith_copy",
    ],
    os.path.join(PROJECT_ROOT, "feature", "feature-prayer-times", "src", "main", "res"): [
        "settings_adhan_volume_vibrate",
        "settings_adhan_vibrate_on",
        "settings_adhan_vibrate_off",
        "settings_preview_stop",
        "settings_method_automatic",
        "settings_method_automatic_desc",
    ],
    os.path.join(PROJECT_ROOT, "feature", "feature-ramadan", "src", "main", "res"): [
        "ramadan_notify_outside",
        "ramadan_notify_outside_desc",
    ],
    os.path.join(PROJECT_ROOT, "feature", "feature-quran", "src", "main", "res"): [
        ...
        "quran_download_sort_mushaf",
        "quran_download_sort_completion",
        "quran_downloads_coverage_title",
        "quran_downloads_coverage_overall",
        "quran_downloads_coverage_empty",
        "quran_recitation_notif_previous",
        "quran_recitation_notif_next",
        "quran_pause_notif_listener",
        "quran_download_playback_title",
        "quran_download_playback_detail",
    ...
    os.path.join(PROJECT_ROOT, "feature", "feature-qibla", "src", "main", "res"): [
        ...
        "mosque_finder_go_to",
        "mosque_finder_find_nearest",
        "mosque_finder_expanding",
    ],
}
...
STRONG_SPECS = {
    ...
    "quran_download_playback_title": [("{{{1}}}", "%1$s")],
    "quran_download_playback_detail": [("{{{1}}}", "%1$s"), ("{{{2}}}", "%2$s")],
    "quran_reciter_changed_message": [("{{{1}}}", "%1$s")],
    "settings_adhan_volume_vibrate": [("{{{1}}}", "%1$s"), ("{{{2}}}", "%2$s")],
    "mosque_finder_expanding": [("{{{1}}}", "%1$s")],
}
