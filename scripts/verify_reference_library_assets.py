...
CORPORA = (
    ...
    CorpusSpec(
        name="Islamic Places and Landmarks",
        legacy=None,
        asset=RAW / "reference_places_landmarks_v2.json",
        min_topics=60,
        min_chapters=7,
        min_revision=1,
        required_topic_ids=frozenset(
    ...
    CorpusSpec(
        name="Expanded Islamic Glossary",
        legacy=None,
        asset=RAW / "reference_islamic_glossary_v2.json",
        min_topics=300,
        min_chapters=9,
        min_revision=1,
        required_topic_ids=frozenset(
