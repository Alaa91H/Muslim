...
import org.example.islamicapp.core.prayer.internal.SolarTime
...
class PrayerTimesCalculator {
    ...
    private fun computeInternal(
        ...
        val maghribMs = if (maghribAngle != null) {
            // maghribAngle is a sun *depression* angle, so it is negated here
            // (the same convention as fajr/isha): the sun must sink to −angle°.
